...
The audit methodology lives in **one** place: [`../universal-audit-skill-v8.0.md`](../universal-audit-skill-v8.0.md) (full) and [`../universal-audit-skill-lite.md`](../universal-audit-skill-lite.md) (low-context). These adapters are thin entry points that point your agent at it — copy the one(s) for your platform into your target project.
