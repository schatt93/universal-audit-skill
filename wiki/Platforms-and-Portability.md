...
The audit methodology is platform-neutral and lives in one source of truth — **`universal-audit-skill-v10.0.md`** (full) and **`universal-audit-skill-lite.md`** (low-context). Thin **adapters** point each platform's native mechanism at it, so there is exactly one methodology to maintain.
